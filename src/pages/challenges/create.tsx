...
export const ChallengeCreate = () => {
  ...
  return (
    <Create saveButtonProps={saveButtonProps}>
      <Form {...formProps} layout="vertical" initialValues={{ type: "lifemastery" }}>
        {/* 챌린지 타입 선택 */}
        ...
        {challengeType === "meditation" && (
          <Card title="🧘 명상 바디더블링 설정" style={{ marginBottom: 24 }}>
            ...
            <Form.Item label="#종료 메시지" name="endMessage">
              <TextArea
                rows={3}
                defaultValue="명상을 종료합니다 ✨ 수고하셨습니다!"
            ...
            <Alert
              message="명상 시간대는 챌린지 생성 후 상세 페이지에서 추가/수정/삭제할 수 있습니다."
              type="warning"
              showIcon
              style={{ marginTop: 16 }}
            />
